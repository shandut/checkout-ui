...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [products, setProducts] = (0, import_react13.useState)([]);
    const [loading, setLoading] = (0, import_react13.useState)(false);
    const [showError, setShowError] = (0, import_react13.useState)(false);
    const {
      merchandise
    } = useTarget();
    const msg = translate(
    ...
    function fetchVariantMetafieldsFromSFAPI() {
      return __async(this, null, function* () {
        setLoading(true);
        try {
    ...
    if (loading) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Spinner2, {});
    }
  ...
  function Extension2() {
    ...
    const calculateTimeLeft = () => __async(this, null, function* () {
      let endTime = yield storage.read("endTime");
      let difference = endTime - (/* @__PURE__ */ new Date()).getTime();
      let timeLeft2 = { minutes: 0, seconds: 0 };
      if (difference > 0) {
        timeLeft2 = {
    ...
    const [timeLeft, setTimeLeft] = (0, import_react14.useState)({ minutes: 5, seconds: 0 });
    (0, import_react14.useEffect)(() => {
      const calculateInitialTimeLeft = () => __async(this, null, function* () {
        let endTime = yield storage.read("endTime");
        let difference = endTime - (/* @__PURE__ */ new Date()).getTime();
        let timeLeft2 = { minutes: 0, seconds: 0 };
        if (difference > 0) {
    ...
    (0, import_react14.useEffect)(() => {
      const initializeEndTime = () => __async(this, null, function* () {
        let endTime = yield storage.read("endTime");
        if (!endTime) {
          endTime = (/* @__PURE__ */ new Date()).getTime() + 5 * 60 * 1e3;
          yield storage.write("endTime", endTime);
        }
      });
      initializeEndTime();
      const timer = setInterval(() => __async(this, null, function* () {
        setTimeLeft(yield calculateTimeLeft());
      }), 1e3);
  ...
  // extensions/checkout-ui/src/Block.jsx
  var import_react15 = __toESM(require_react());
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var Block_default = reactExtension(
